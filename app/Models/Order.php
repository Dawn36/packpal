...
class Order extends Model
{
  ...
  public function orderDataBuyer(string $status, int $userId)
  {
    return DB::table('orders AS o')
      ...
      ->select(DB::raw('o.s_user_id,o.b_user_id,u.`id` AS user_id,u.`profile_picture`,u.`first_name`,u.`last_name`,b.`bids_name`,b.`thumbnail`,c.`category_name`,sc.`sub_category_name`,o.offer_price,o.feed_back,o.created_at,o.id'))
