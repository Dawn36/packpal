...
<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bolder my-1 fs-3">Categories</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">
                    <a href="#" class="text-white text-hover-primary">Categories List</a>
                </li>
                    ...
                    <div class="card card-docs mb-2">
                        <div class="p-10">
                            ...
                            <h1 class="anchor fw-bolder mb-5" id="zero-configuration">
                                <a href="javascript:;"></a>Categories List
                            </h1>
                            <!--begin::Notice-->
                            <div class="d-flex align-items-center rounded py-5 px-4 bg-light-dark">
                                ...
                                <!--end::Icon-->
                                <!--begin::Description-->
                                <div class="text-gray-700 fw-bold fs-6 lh-lg">Here we have a list of all of the Categories that are saved in the Database.</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Notice-->
                            <!--end::Heading-->
                                ...
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    <thead>
                                        <tr class="fw-bold fs-6 text-muted">
                                            ...
                                            <th class="min-w-100px">Total Sub-Categories</th>
                                            <!-- <th class="min-w-100px">Total Ads</th> -->
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        @for ($i = 0; $i < count($categories); $i++) <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-original-title="Edit Category" onclick="editCategories('{{$categories[$i]->id}}')">
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                <form style="display: inline-block" method="POST" action="{{ route('categories.destroy', $categories[$i]->id) }}">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2" data-bs-toggle="tooltip" data-bs-original-title="Delete Category">
                                                        <span class="svg-icon svg-icon-2">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<script>
    ...
    function addCategories() {
        ...
        $.ajax({
            ...
            success: function(result) {
                $('#myModalLgHeading').html('Add Category');
    ...
    function editCategories(id) {
        ...
        $.ajax({
            ...
            url: url,
            success: function(result) {
                $('#myModalLgHeading').html('Edit Category');
                $('#modalBodyLarge').html(result);
                $('#myModalLg').modal('show');
            }
        });
