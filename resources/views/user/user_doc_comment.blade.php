                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="pe-5">
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-1">
                            <a href="#" class="fw-bolder text-dark text-hover-primary">{{ucwords($user[0]->first_name)}} {{ucwords($user[0]->last_name)}}</a>
                        </div>
                        <!--end::Author details-->
...
<form id="kt_inbox_reply_form" class="rounded border mt-10" method="POST" action="{{ route('user_comment_submit', $userId) }}">
    @csrf
