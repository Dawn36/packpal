                        ...
                        <div class="card-body">
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="fw-bolder mt-5">Subscription Expiry date</div>
                                    <div class="text-gray-600">{{ is_null($userData->expiry_date) ? 'You did not subscribe' : DATE("Y-m-d",strtotime($userData->expiry_date))}}</div>
                                    <div class="fw-bolder mt-5 mb-2">Verified</div>
                                    <div class="text-gray-600" >
                                        @if($userData->verified == 'no')
                                        {{'Please send doc to admin for verification'}}
                                        @else
