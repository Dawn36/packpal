                            ...
                            <div class="py-5">
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        @for ($i = 0; $i < count($subscriptionRequest); $i++) @php $a=$i; $a++; @endphp <tr>
                                            <td>{{$a}}</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="me-5 position-relative">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic" src="{{asset('/profile/' . $subscriptionRequest[$i]->profile_picture)}}">
                                                        </div>
                                                        <!--end::Avatar-->
                                                    </div>
                                                    <!--end::Wrapper-->
                                            ...
                                            <td><div class="symbol-group symbol-hover flex-nowrap">
                                                @php $pathArr=explode(',',$subscriptionRequest[$i]->path) @endphp 
                                                @for ($j = 0; $j < count($pathArr); $j++)
                                                <a href='{{asset( $pathArr[$j])}}' target="_blank" class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" aria-label="Michael Eberon" data-kt-initialized="1">
                                                    <img alt="Pic" src="{{asset( $pathArr[$j])}}">
                                                </a>
                                                @endfor
                                                
                                            </div></td>
                                            <td>{{Date('Y-m-d',strtotime($subscriptionRequest[$i]->created_at))}}</td>
                                            <td>
                                                <a href="{{route('user_subscription_accept_reject',['userId'=>$subscriptionRequest[$i]->user_id,'month'=>$subscriptionRequest[$i]->package,'status'=>'accept'])}}" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-success" data-bs-toggle="tooltip" data-bs-original-title="Accept ">
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                <a href="{{route('user_subscription_accept_reject',['userId'=>$subscriptionRequest[$i]->user_id,'month'=>$subscriptionRequest[$i]->package,'status'=>'reject'])}}" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger" data-bs-toggle="tooltip" data-bs-original-title="Reject ">
