    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">
                    <a href="#" class="text-white text-hover-primary">Pending Bids </a>
                </li>
                                ...
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody>
                                        @for ($i = 0; $i < count($bids); $i++) @php $a=$i; $a++; @endphp <tr>
                                            ...
                                            <td>
                                                <a href="javascript:;" class="btn btn-lg btn-light-warning  fw-bolder ms-2 fs-8 py-1 px-3">{{ucwords($bids[$i]->status)}}</a>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('bid_accept', $bids[$i]->id) }}" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-success" data-bs-toggle="tooltip" data-bs-original-title="Accept Bids">
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                <button type="button" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger" data-bs-toggle="tooltip" data-bs-original-title="Reject Bids" onclick="rejectBids('{{$bids[$i]->id}}')">
