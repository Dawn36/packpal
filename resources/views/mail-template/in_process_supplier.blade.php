            ...
            <tr>
                <td align="left" valign="center">
                    <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 43px;">
                        ...
                        <div style="padding-bottom: 30px">The Offer has been accepted by the Buyer against the BID <b>{{ucwords($data['bid_name'])}}</b> You can still use our <b>CHAT</b> feature to talk to the buyer directly.</div>
                        <div style="padding-bottom: 30px">You can check the status of your BID by going in your <b>DASHBOARD</b> and clicking on <b>OFFERS</b>. Now, click on the <b>In-Process</b> section where you can still reject the accepted offer in case satisfaction is not met with the buyer. When the deal is closed make sure to mark it <b>COMPLETE</b> and ask the Buyer to review. This way other buyers can conduct business with confidence.</div>
