            ...
            <tr>
                <td align="left" valign="center">
                    <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 43px;">
                        ...
                        <div style="padding-bottom: 30px">You received a new BID against your <b>{{ucwords($data['bid_name'])}}</b> from a supplier. Kindly go through the offer and check the suppliers profile by clicking on the supplier name under <b>{{ucwords($data['supplier_name'])}}<b> column before accepting the offer. You may even <b>CHAT</b> with supplier before offer acceptance by clicking on the right side corner of the row.</div>
