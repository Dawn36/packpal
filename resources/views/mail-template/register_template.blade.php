                ...
                <td align="left" valign="center">
                    <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 43px;">
                        ...
                        <div style="padding-bottom: 30px; font-size: 17px;">
                            <strong>Dear PackPal User,</strong>
                        </div>
                        <div style="padding-bottom: 30px">Warm Greetings from PackPal Team.</div>
                        <div style="padding-bottom: 30px">We welcome you on board to the Pakistans best and the only B2B platform for Packaging that connects Buyers & Sellers. Here you can search different suppliers serving in different packaging domains as well as buyers who are ready to built new relationships and businesses.</div>
                        <div style="padding-bottom: 30px">Enjoy the platform as its FREE for Limited time. We wish you prosperous business with us.</div>
                        <div style="padding-bottom: 30px">Our Team is always here to help you. Feel free to send us any query that you have to our customer Support at customercare@packpal.pk</div>
