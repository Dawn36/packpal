      ...
      <div class="row align-items-center">
        <div class="pl-4 col-lg-5 col-md-5 pr-4">
          <img
            ...
            src="{{ asset('theme/website-assets/images/about.jpg')}}"
            alt="Card image cap"
          />
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
          <div class="mt-4 mb-4">
            <i
              class="text-success mdi mdi-account-multiple-outline mdi-48px"
            ></i>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
          <div class="mt-4 mb-4">
            <i
              class="text-success mdi mdi-comment-alert-outline mdi-48px"
            ></i>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4">
          <div class="agents-card text-center">
            <img class="img-fluid mb-4" src="{{ asset('theme/website-assets/images/user/s1.png')}}" alt="" />
            <p class="mb-4">
              Lorem Ipsum is simply dummy text of the printing and typesetting
        ...
        <div class="col-lg-4 col-md-4">
          <div class="agents-card text-center">
            <img class="img-fluid mb-4" src="{{ asset('theme/website-assets/images/user/s2.png')}}" alt="" />
            <p class="mb-4">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry. Lorem Ipsum has been.
            </p>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="agents-card text-center">
            <img class="img-fluid mb-4" src="{{ asset('theme/website-assets/images/user/s3.png')}}" alt="" />
            <p class="mb-4">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry. Lorem Ipsum has been.
            </p>
