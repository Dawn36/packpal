<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" method="POST" action="{{ route('product.update',$product->id) }}" enctype="multipart/form-data">
    @method("PUT")
    @csrf
    <!--begin::Aside column-->
    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body text-center pt-0">
                <!--begin::Image input-->
                <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url({{asset('products/'.$product->thumbnail)}})">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <select name='status' id="" class="form-select mb-2 kt_ecommerce_add_product_status_select1" onchange="statusChange()" data-control="select2" data-hide-search="true" data-placeholder="Select an option" required>
                    <option value="active" {{$product->status == 'active' || $product->status == 'pending' ? 'selected' :''}}>Active</option>
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0 pb-0">
                ...
                <select class="form-control required form-control-lg form-control-solid" id='category_id' name="category_id" required onchange="getSubCategoryAjax()">
                    ...
                    @for ($i = 0; $i < count($categories); $i++) <option value="{{$categories[$i]->id}}" {{$product->categories_id == $categories[$i]->id ? 'selected' :''}}>{{ucwords($categories[$i]->category_name)}}</option>
                        @endfor
                </select>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="kt_ecommerce_add_product_general" role="tab-panel">
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="product_name" value="{{$product->product_name}}" class="form-control mb-2" placeholder="Product name" value="" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="location" value="{{$product->location}}" class="form-control mb-2" placeholder="Location" value="" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="city_post_code" value="{{$product->city_post_code}}" class="form-control mb-2" placeholder="City/ PostCode" value="" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="number" min="0" name="contact_no" class="form-control mb-2" placeholder="Tel No." value="{{$product->contact_no}}" required />
                    ...
                    <div class="card card-flush py-4">
                        <!--begin::Card header-->
                        <input type="hidden" id='product_Image' value="{{$productImage}}" />
                        <div class="card-header">
                            <div class="card-title">
                                <h2>Media</h2>
                            </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" min="0" name="target_price" value="{{$product->target_price}}" class="form-control mb-2" placeholder="Product target price" value="" required />
                                <!--end::Input-->
                                <!--begin::Description-->
...
<script>
            ...
            success: function(result) {
                if (result == 0) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        if (result[i].id == "{{ $product->sub_categories_id }}") opt.defaultSelected =
                            true;
    ...
    var addsImage = document.getElementById('product_Image').value;
    ...
    new Dropzone(".kt_ecommerce_add_product_media", {
        ...
        url: "{{ route('product_upload_image') }}",
        ...
        init: function() {
            ...
            this.on("removedfile", function(file) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{ route('product_delete_image') }}",
                    data: value,
