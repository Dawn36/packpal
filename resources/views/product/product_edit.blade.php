                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="number" name="contact_no" class="form-control mb-2" placeholder="Tel No." value="{{$product->contact_no}}" required />
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" name="target_price" value="{{$product->target_price}}" class="form-control mb-2" placeholder="Product target price" value="" required />
                                <!--end::Input-->
                                <!--begin::Description-->
