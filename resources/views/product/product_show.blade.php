        ...
        <div class="page-title d-flex flex-column me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <li class="breadcrumb-item text-white opacity-75">
                    <a href="{{ route('product_status', ['status' => 'active']) }}" class="text-white text-hover-primary">Home</a>
                </li>
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">
                    <a href="#" class="text-white text-hover-primary">Product Details</a>
                </li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="{{asset('/products/' . $product->thumbnail)}}" alt="image" />
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">Product Name: <span class="text-primary text-decoration-underline">{{ucwords($product->product_name)}}</span></a>
                                        <a href="#">
                                ...
                                <div class="d-flex my-4">
                                    <button class="btn btn-sm btn-circle btn-primary me-2" onclick="editProduct('{{$product->id}}')">Edit product</button>
                                </div>
                                <!--end::Actions-->
                            </div>
                            <!--end::Title-->
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{$product->target_price}}" data-kt-countup-prefix="$">{{$product->target_price}}</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                        ...
                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--end::Svg Icon-->
                                                <div class="fs-2 fw-bolder">{{ucwords($product->categories->category_name)}}</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                        ...
                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--end::Svg Icon-->
                                                <div class="fs-2 fw-bolder">{{ucwords($product->subCategories->sub_category_name)}}</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                        <!--begin::Nav item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary py-5 me-6 active" href="ad_view.php">Product Details</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <!-- <li class="nav-item">
                            <a class="nav-link text-active-primary py-5 me-6" href="offer_view.php">Offer</a>
                        </li> -->
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <!-- <li class="nav-item">
                            <a class="nav-link text-active-primary py-5 me-6 " href="gigs_reviews.php">Product Reviews</a>
                        </li> -->
                    ...
                    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <span class="fw-bolder fs-6 text-gray-800">{{ucwords($product->product_name)}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ucwords($product->categories->category_name)}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ucwords($product->subCategories->sub_category_name)}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--begin::Input group-->
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">@php echo html_entity_decode($product->description) @endphp</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--begin::Input group-->
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">${{ucwords($product->target_price)}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ucwords($product->location)}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ucwords($product->city_post_code)}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ucwords($product->contact_no)}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--begin::Input group-->
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{Date("Y-m-d",strtotime($product->created_at))}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                        <div class="card-header cursor-pointer">
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0">Product Photos</h3>
                            </div>
                        </div>
                        <div class="card-body p-9">
                            <div class="row mb-7">
                                <!--begin::Col-->
                                @for ($i = 0; $i < count($productImage); $i++) <div class="col-lg-3">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay" data-fslightbox="lightbox-basic" href="{{asset('products/'.$productImage[$i]->path)}}">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style="background-image:url({{asset('products/'.$productImage[$i]->path)}})">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
...
<!--begin::Modal - Give Feedback-->
<div class="modal fade" id="kt_modal_give_feedback" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Give Feedback</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <!--begin::Modal body-->
            <!--begin::Modal body-->
            <div class="modal-body scroll-y mx-10 mb-0 pb-0">
                <!--begin::Form-->
                <form id="" class="form" action="#">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        <div class="row mb-7">
                            <div class="col-lg-12">
                                <label class="required fw-bold fs-6 mb-2">Ratings</label>
                                <div class="rating">
                                    <!--begin::Reset rating-->
                        ...
                        <div class="row mb-7">
                            <div class="col-lg-12">
                                <label class="required fw-bold fs-6 mb-2">Feedback</label>
                                <textarea name="feedback" cols="30" rows="5" class="form-control form-control-solid" placeholder="Please share your feedback with this us!"></textarea>
                            </div>
                        </div>
                    </div>
                    <!--end::Scroll-->
...
<!--end::Modal - Give Feedback-->

<!--begin::Modal - Edit Offer On This Ad-->
<div class="modal fade" id="kt_modal_edit_offer_ad" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <!--begin::Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Edit Offer On This Ad</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                        ...
                        <div class="row mb-7">
                            <div class="col">
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <input type="text" name="offer_price" class="form-control" placeholder="Please Enter your Offer price here." />
...
<!--end::Modal - Edit Offer On This Ad-->
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Edit a Ad</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <!--end::Modal header-->
            <!--begin::Modal body-->
            <div class="modal-body scroll-y p-12" style="background-color: #f5f8fa;">
                <!--begin::Form-->
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <!--end::Image input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Set the ad thumbnail image. Only *.png, *.jpg and *.jpeg image files are accepted</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Card body-->
                        </div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <div class="rounded-circle bg-success w-15px h-15px kt_ecommerce_add_product_status" id=""></div>
                                </div>
                                <!--begin::Card toolbar-->
                            </div>
                            <!--end::Card header-->
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Select2-->
                                <select class="form-select mb-2 kt_ecommerce_add_product_status_select" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="">
                                    <option></option>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">Gig Name</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="ad_name" class="form-control mb-2" placeholder="Gig name" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                <div class="text-muted fs-7">Gig name is required and recommended to be unique.</div>
                                                <!--end::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="location" class="form-control mb-2" placeholder="Location" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                <div class="text-muted fs-7">Location is required for ad posting.</div>
                                                <!--end::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="city" class="form-control mb-2" placeholder="City/ PostCode" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="tel" name="phone_number" class="form-control mb-2" placeholder="Tel No." value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
...
<!--begin::Modal - Chat with Company-->
<!--begin::Modal - Company Info-->
<div class="modal fade" id="kt_modal_company_info" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <!--begin::Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Company Info</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
            ...
            <!--begin::Modal body-->
            <!--begin::Modal body-->
            <div class="modal-body scroll-y mb-0 pb-0" style="background-color: #f5f8fa;">
                <!--begin::Layout-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-center flex-column py-5">
                                    ...
                                    <div class="symbol symbol-100px symbol-circle mb-7">
                                        <img src="assets/media/logos/logistics.jpg" alt="image" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-5">The Grand Logistics</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="mb-9">
                                        <!--begin::Badge-->
                                    ...
                                    <div class="d-flex flex-wrap flex-center fs-8">
                                        ...
                                        <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3 text-center">
                                            <div class="fs-5 fw-bolder text-gray-700">
                                                <span class="w-75px">25/05/2022</span>
                                            </div>
                                ...
                                <div id="kt_user_view_details" class="collapse show">
                                    <div class="pb-5 fs-6">
                                        <div class="fw-bolder mt-5">Company ID</div>
                                        <div class="text-gray-600">1</div>

                                        <div class="fw-bolder mt-5">Languages</div>
                                        <div class="text-gray-600">German</div>

                                        <div class="fw-bolder mt-5">Email</div>
                                        <a href="#" class="text-gray-600 text-hover-primary">tiger223@gmail.com</a>

                                        <div class="fw-bolder mt-5">Street</div>
                                        <div class="text-gray-600">Sonnenallee 43</div>

                                        <div class="fw-bolder mt-5">City</div>
                                        <div class="text-gray-600">Augsburg</div>

                                        <div class="fw-bolder mt-5">Country</div>
                                        <div class="text-gray-600">Germany</div>

                                        <div class="fw-bolder mt-5">Phone Number</div>
                                        <a href="#" class="text-gray-600 text-hover-primary">+49 30 568955934</a>

                                        <div class="fw-bolder mt-5">Tax Number</div>
                                        <a href="#" class="text-gray-600 text-hover-primary">+49 30 568955934</a>

                                        <div class="fw-bolder mt-5">Local Court</div>
                                        <a href="#" class="text-gray-600 text-hover-primary">$</a>
                                    </div>
                                    <div class="pb-5 fs-6">
                                        <hr>
                                        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-10">Ratings</a>
                                        <div class="d-flex justify-content-between horizontal-center">
                                            ...
                                            <div class="rating-orders">
                                                <a class="btn btn-sm btn-light-primary">(27)</a>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-between horizontal-center">
                                            <div class="rating custom-ratings-placement">
                                            ...
                                            <div class="rating-orders">
                                                <a class="btn btn-sm btn-light-primary">(6)</a>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-between horizontal-center">
                                            <div class="rating custom-ratings-placement">
                                            ...
                                            <div class="rating-orders">
                                                <a class="btn btn-sm btn-light-primary">(12)</a>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-between horizontal-center">
                                            <div class="rating custom-ratings-placement">
                                            ...
                                            <div class="rating-orders">
                                                <a class="btn btn-sm btn-light-primary">(2)</a>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-between horizontal-center">
                                            <div class="rating custom-ratings-placement">
                                            ...
                                            <div class="rating-orders">
                                                <a class="btn btn-sm btn-light-primary">(1)</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-flush mb-6 mb-xl-9">
                                            ...
                                            <div class="card-header mt-6">
                                                ...
                                                <div class="card-title flex-column">
                                                    <h2 class="mb-1">Total Categories</h2>
                                                </div>
                                                <!--end::Card title-->
                                            </div>
                                            <!--end::Card header-->
                                            <!--begin::Card body-->
                                            <div class="card-body px-9 py-0">
                                    ...
                                    <div class="tab-pane fade show active" id="kt_user_view_ads_tab" role="tabpanel">
                                        ...
                                        <div class="card card-flush mb-6 mb-xl-9">
                                            ...
                                            <div class="card-header mt-6">
                                                <!--begin::Card title-->
                                                <div class="card-title flex-column">
                                                    <h2 class="mb-1">Total Sub-Categories</h2>
                                                </div>
                                                <!--end::Card title-->
                                            </div>
                                            <!--end::Card header-->
